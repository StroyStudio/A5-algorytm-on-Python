...
seed = input("Enter the seed of coded file: ")

print("Reading coded audio file:", end=' ')
FrameInput = read_audio_file("coded.wav")
print("Done.")

print("Getting audio info:", end=' ')
info = audio_info("coded.wav")
print("Done.")
...
write_audio_file(FrameOut, "decoded.wav", info)
print("Done.")
